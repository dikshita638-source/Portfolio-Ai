    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    @foreach(['Home' => 'home', 'About' => 'about', 'Skills' => 'skills', 'Projects' => 'projects', 'Experience' => 'experience', 'Contact' => 'contact'] as $label => $id)
                        <a href="#{{ $id }}" class="text-white/40 text-sm hover:text-primary-400 transition-colors duration-300">
                            {{ $label }}
                        </a>
                    @endforeach
                </div>
        ...
        <div class="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-white/30 text-sm font-mono">
                &copy; {{ date('Y') }} Dikshita. All rights reserved.
            </p>
