<?php $__env->startComponent('components.section', ['id' => 'contact']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => 'Get In Touch','subtitle' => 'Contact']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Get In Touch','subtitle' => 'Contact']); ?>
...
<?php endif; ?>
    ...
    <div class="grid lg:grid-cols-5 gap-12 lg:gap-16">
        ...
        <div class="lg:col-span-3" data-aos="fade-left" data-aos-duration="800">
            <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="glass-card p-8 rounded-2xl">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php /**PATH E:\portfolio-ai\resources\views/sections/contact.blade.php ENDPATH**/ ?>