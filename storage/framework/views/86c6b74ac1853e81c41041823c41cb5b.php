<footer class="relative border-t border-white/5 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                <a href="#home" class="text-2xl font-display font-bold bg-gradient-to-r from-primary-400 to-purple-400 bg-clip-text text-transparent">
                    Dikshita
                </a>
                <p class="text-white/40 text-sm mt-3 leading-relaxed max-w-xs">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <?php $__currentLoopData = ['Home' => 'home', 'About' => 'about', 'Skills' => 'skills', 'Projects' => 'projects', 'Experience' => 'experience', 'Contact' => 'contact']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="#<?php echo e($id); ?>" class="text-white/40 text-sm hover:text-primary-400 transition-colors duration-300">
                            <?php echo e($label); ?>
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="#" class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300" aria-label="Instagram">
        ...
        <div class="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-white/30 text-sm font-mono">
                &copy; <?php echo e(date('Y')); ?> Dikshita. All rights reserved.
            </p>
...
<?php /**PATH E:\portfolio-ai\resources\views/components/footer.blade.php ENDPATH**/ ?>